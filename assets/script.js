...
function displayRecipes(meals,event){
console.log(meals);
...
for (let i = 0; i< meals.length; i++) {
  ...
  //let titleName = document.getElementById("recipe-name " + i);
  let measurements = document.createElement("p");
  measurements.id = "measurements-info " + i;
  //mealName.parentNode.insertBefore(measurements, mealName.nextSibling);

  mealName.textContent = meals[i].strMeal;
  ...
  for (var j = 1; j <= 20; j++) {
    ...
    var ingredientValue = meals[i][ingredientKey];
    var measureKey = "strMeasure" + j;
    var measureValue = meals[i][measureKey];

    console.log(measureValue, ingredientValue);
// displays the values under the photo
    if (ingredientValue && measureValue) {
